...
import { tours, categoryLabel, Tour } from "@/data/tours";
...
function PriceHistogram({ range }: { range: [number, number] }) {
...
function SearchResults() {
  ...
  const filtered = useMemo(() => {
    ...
    return result;
  }, [destino, cats, horario, price, durIdx, viajante, idiomas, acess, sortBy]);
